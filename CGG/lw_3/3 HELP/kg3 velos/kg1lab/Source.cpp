...
int WINAPI _tWinMain(HINSTANCE hInstance, HINSTANCE, LPTSTR lpszCmdLine, int nCmdShow)
{
	...
	HWND hWnd = CreateWindowEx(0, TEXT("NewWindowClass"), TEXT("������������ ������� � ���������. ������������ ������ �3"),
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		...
		SetTimer(hWnd, 1, 40, NULL); // ������������� ������ ~ 25 FPS
		return 0;
	}
	break;
	...
	case WM_DESTROY:
	{
		...
		Gdiplus::GdiplusShutdown(gdiplusToken); // ���������� ������ GDI+
		PostQuitMessage(0);
	}
	break;
...
Gdiplus::PointF big_star1[2] = { // ������� ������
	Gdiplus::PointF(x + 335, y + 329),
	Gdiplus::PointF(x + 365, y + 329)
};

Gdiplus::PointF big_star2[2] = { // ������� ������
	Gdiplus::PointF(x + 350, y + 344),
	Gdiplus::PointF(x + 350, y + 314)
};

int sx5 = x + 335, sy5 = y + 314;
Gdiplus::PointF big_star3[8] = { // ������� ������
...
void  Display(HDC  hdc)
{
...

	{
		...
		if ((Time > Timing_1_2) && Time < Timing_2) // ��������� �����
		{
			mtrx.Translate(20, 0);
	...
	graph.DrawImage(&backbuffer, rect); // ������� �� ����� ������� ����������� �� ������								
}  //  Display
